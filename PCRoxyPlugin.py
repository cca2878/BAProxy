...
from BAProxy import _PCRoxy_core, FuncNode, BAProxy, BAProxyMode
from tools.BAPRoxyLog import BAPoxyLog


def get_core() -> BAProxy:
...
@BAPoxyLog
class PCRoxyPlugin:
    def __init__(self, name: str = None, mode_list: List[BAProxyMode] = []):
